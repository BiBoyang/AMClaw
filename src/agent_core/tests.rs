use super::{
    ...
    AgentTraceIndexEntry, BusinessContextSnapshot, ContextAssembler, ContextPreviewMode, DoneRule,
    DropReason, ExecutionPlan, ExpectedObservation, FailureAction, FailureDecision, GoalSignal,
