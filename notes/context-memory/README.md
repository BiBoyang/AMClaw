...
本目录用于存放 `Context / Memory / 状态管理` 相关讨论纪要与设计草案。
...
- `CONTEXT-MEMORY-EVOLUTION-ROADMAP-2026-04-13.md`：基于 AMClaw 当前代码现状整理的下一阶段 Context / Memory 演进路线图。
- `PHASE-1-MEMORY-V3-SEMANTICS-TASKLIST-2026-04-13.md`：把 “收口 Memory v3 语义” 拆成可执行开发任务的清单。
